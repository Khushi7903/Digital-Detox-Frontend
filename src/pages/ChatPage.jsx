  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-white flex items-center justify-center px-4 pt-28 pb-16">
        ...
        >
          {/* Image for large devices (left side) */}
          <div className="hidden md:flex w-full md:w-1/2 items-center justify-center bg-green-50 p-4">
            <img
              src={userImage}
              alt="Suraksha Buddy"
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            {/* Image for small devices (below title) */}
            <div className="block md:hidden w-full flex items-center justify-center bg-green-50 p-4">
              <img
                src={userImage}
                alt="Suraksha Buddy"
                className="w-32 h-32 sm:w-36 sm:h-36 md:w-44 md:h-44 rounded-full object-cover"
